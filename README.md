...
| HT-004 | Calculadora de actualización por tasas | Actualización de montos por series de tasas; los datos viven en `herramientas/tasas_data.js` y se cargan importando Excel |
...
│   ├── calculadora_tasas.html
│   └── tasas_data.js         ← base de datos de tasas (se reemplaza al actualizar)
└── README.md
```
